...
\subsection{1st approach: direct Kotlin API usage}

\subsubsection{Pattern 1: explicit align/dealign}

\subsection{2nd approach: declarative and modular API}

\subsubsection{Pattern 2: simple aggregate operations in loops}

\subsection{3rd approach: visitor pattern}

\subsubsection{Pattern 3: unnecessary Yielding usage}

\subsubsection{Pattern 4: unnecessary construct usage}

\subsection{4th approach: mixed approach}

\subsubsection{Pattern 5: improper Evolve construct usage}

\subsubsection{Pattern 6: complex aggregate operations in loops}
