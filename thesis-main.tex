...
minimalistic syntax. 
%
The flexibility of aggregate computing lies in its ability to build reusable
computational blocks. These blocks can be composed to address complex
requirements while maintaining modularity, enabling developers to reason about
collective behaviors at higher levels of abstraction. Tools like Protelis
\cite{DBLP:conf/saso/PianiniBV17}, ScaFi \cite{DBLP:conf/ecoop/CasadeiV16} and
the recently proposed eXchange Calculus (XC)
\cite{DBLP:journals/jss/AudritoCDSV24} extend field calculus principles,
