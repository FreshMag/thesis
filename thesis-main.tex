...
evolve, and it is used to compute the value returned by the anonymous function passed to
the \lstinline{evolve} construct.

\subsubsection{Design and Implementation}

The description of the pattern seems quite simple, however the implementation of 
the checker is not as trivial as it may seem. 
