...
\note{Here it's not clear that it's talking about the tools for enforce coding standards}
...
\note{TODO link to the next paragraph}
...
\sidenote{Fix starting text of this section}The frontend is also responsible for communicating with IDEs and build tools, 
